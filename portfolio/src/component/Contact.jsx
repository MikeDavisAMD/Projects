      ...
      <Grid size={{lg:6,md:6,sm:12,xs:12}}>
        <Box sx={{p:2,backgroundColor:'#F5F7FA'}}>
          ...
          <Box sx={{display:'flex',justifyContent:'center',p:2}}>
            <Button variant='contained' sx={{width:'460px'}} onClick={handleMailSender}>send message</Button>
          </Box>
        </Box>
        <Snackbar
        open={open}
      ...
      <Grid size={{lg:6,md:6,sm:12,xs:12}}>
        <Box sx={{p:4,backgroundColor:'#F5F7FA'}}>
          ...
          <Box sx={{display:'flex',gap:2,p:0.8,pl:{lg:0,md:0,sm:15,xs:0}}}>
            ...
            <IconButton disableRipple href='https://www.instagram.com/m.d.falcon73?igsh=MW1nazBqYmNjcmI4Yw%3D%3D&utm_source=qr'
            sx={{'&:hover':{color:'#34A853'}}}>
              <Instagram/>
            </IconButton>
